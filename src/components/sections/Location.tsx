      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-8 italic text-shadow-food">
            KOM <span className="text-brand-red decoration-brand-charcoal underline underline-offset-8">LANGS</span>
          </h2>
          <p className="text-gray-500 mb-12 text-sm md:text-lg font-bold uppercase tracking-widest leading-none">
            In het hart van Brakkenstein • Nijmegen
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-brand-red">
                ...
                <span className="text-xs font-black uppercase tracking-widest">Adres</span>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-brand-red">
                ...
                <span className="text-xs font-black uppercase tracking-widest">Afhalen</span>
              </div>
              <p className="text-brand-charcoal font-black text-xl uppercase tracking-tight">
                Ma t/m Zo: 12:00 — 23:00
              </p>
            </div>
            ...
            >
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-black uppercase tracking-widest">Volg ons</span>
               </div>
        ...
        <div className="relative aspect-square md:aspect-video rounded-none overflow-hidden bg-brand-charcoal shadow-[30px_30px_0px_0px_rgba(229,62,62,1)]">
           <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2462.4839356673514!2d5.867962477382436!3d51.815591388147!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c709ab82302633%3A0xe53e9a4f4f4f4f4f!2sKanunnik%20Boenenstraat%202-4%2C%206525%20WS%20Nijmegen!5e0!3m2!1snl!2snl!4v1712930000000!5m2!1snl!2snl"
              width="100%"
              height="100%"
