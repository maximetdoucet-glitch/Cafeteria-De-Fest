    ...
    <div className="w-full h-screen h-[100dvh] bg-white flex flex-col md:flex-row relative overflow-hidden">
      ...
      {step !== 'success' && (
        <button 
          ...
          title="Annuleren"
          className="fixed top-6 right-6 z-50 flex items-center gap-2 px-6 py-3 bg-brand-charcoal text-white font-black uppercase tracking-widest text-[10px] hover:bg-brand-red transition-all shadow-xl rounded-full md:rounded-none group"
        >
          <span>Annuleren</span>
          ...
          <div className="hidden md:flex w-80 h-full bg-brand-charcoal p-10 flex-col justify-between text-white border-r border-white/10 shrink-0">
            <div>
              <div className="mb-12">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <span className="font-heading font-black text-xl italic uppercase tracking-tighter">De Fest.</span>
                </div>
                ...
                {steps.map((s, idx) => (
                  <div key={s.id} className="flex items-center space-x-4">
                    ...
                    <span className={`text-[10px] uppercase tracking-widest font-black transition-colors ${
                      idx <= currentStepIndex ? "text-white" : "text-white/30"
                    }`}>
                      {s.label}
                    </span>
                  </div>
                          ...
                          {cat.items.map(item => {
                            ...
                            return (
                              <button 
                                ...
                                className={`flex items-center justify-between p-5 bg-white border-2 transition-all group ${
                                  selected ? "border-brand-red ring-1 ring-brand-red/20 shadow-md" : "border-brand-charcoal/5 hover:border-brand-charcoal/20"
                                }`}
                              >
                    ...
                    <div className="bg-white border-2 border-brand-charcoal shadow-xl p-8 mb-8 relative overflow-hidden">
                       ...
                       <div className="border-t-2 border-brand-charcoal pt-6 flex justify-between items-end">
                          ...
                          <div className="text-right">
                             ...
                             <span className="text-[8px] font-black text-brand-charcoal/30 uppercase tracking-[0.2em]">DE FEST NIJMEGEN</span>
                          </div>
                       </div>
                    </div>
                  </motion.div>
                ...
                {step === 'success' && (
                  ...
                  >
                    ...
                    <div className="bg-brand-cream border-2 border-brand-charcoal/5 p-8 max-w-md mx-auto relative overflow-hidden group mb-12">
                       ...
                       <a 
                        href="https://google.com/search?q=Cafetaria+De+Fest+Nijmegen" 
                        target="_blank"
                     ...
                     <div className="flex flex-col gap-4 max-w-sm mx-auto">
                       <a 
                         href={`mailto:orders@cafetariadefest.nl?subject=Nieuwe%20Bestelling%20-%20${encodeURIComponent(userName)}&body=${encodeURIComponent("Bestelling van: " + userName + "\nTotaal: €" + totalPrice.toFixed(2) + "\n\nBekijk het dashboard voor meer details.")}`}
